...
// GetNewAllLiked provides a mock function with given fields: ctx, id, lastId
func (_m *Store) GetNewAllLiked(ctx context.Context, id int, lastId int) ([]*explore.ListLikedYouResponse_Liker, int, error) {
	ret := _m.Called(ctx, id, lastId)
